        ...
        <div class="shadow-lg rounded-2xl p-4 bg-white dark:bg-gray-800 sm:block my-4 mb-4 mx-4">
            <div class="flex justify-items-center mb-4">
                ...
                <select name="select-informe" id="select-informe" class="laradash-input"  v-model="tipo_informe">
                    ...
                    <option value="2" class="">Productos más vendidos por Sucursal/Pais</option>
                ...
                <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                        <table class="min-w-full leading-normal">
                            ...
                            <tbody>
                                <tr  v-for="p in ventas_x_sucursal" :key="p.id">
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <div :class="`px-6 py-4 flex-1 flag-icon flag-icon-${p.iso_code}`"></div>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                                            ...
                                            <span class="relative">
                                                {{ formatter.format(p.venta_sucursal) }}
                                            </span>
                                        </span>
                                    </td>
                                </tr>
...
<script setup>
    ...
    const ventas_x_sucursal = props.ventas_x_sucursal
